...
if user_type == "Company User":
    ...
    def generate_suggestions(energy_usage, waste, business_travel, electricity_bill, 
                            natural_gas_bill, fuel_bill, waste_per_month, recycling_percent):
        ...
        sorted_emissions = sorted(emissions_breakdown.items(), key=lambda x: x[1], reverse=True)
    ...
    if st.button("Calculate Carbon Footprint", key="calculate"):
        if not company_name:
            ...
            report_data = {
                ...
                "total": CO2_from_energy_usage + CO2_from_waste + CO2_from_business_travel
            }
            ...
            with res_col2:
                ...
                st.markdown(get_csv_download_link(results_df, 
                          ...
                          "📥 Download Data as CSV"), unsafe_allow_html=True)
           ...
           # Suggestions Section
            ...
            with tab1:
                if suggestions["energy"]:
                    ...
                    st.markdown("Your energy usage is relatively efficient. Continue monitoring!")
            ...
            st.markdown(get_csv_download_link(suggestions_df, 
                      f"carbon_reduction_suggestions_{company_name}.csv",
                      "📥 Download Suggestions Report"), unsafe_allow_html=True)
            
            # Add an estimation of potential reduction
            potential_reduction = total_emissions * 0.3  # Assuming 30% reduction potential
            st.info(f"""
    ...
    if not st.session_state.companies_data:
        ...
        fig = px.bar(df, x='company_name', y=['energy_usage', 'waste', 'business_travel'],
